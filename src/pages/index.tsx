    ...
    <>
      ...
      <main className="p-6">
        <p className="text-left">
          ...
          the compilation of{' '}
          <a className="text-info" href="bit.ly/ANTIRACISMRESOURCES">
          ...
          <a className="text-info" href="https://www.academia.sg/">
            Academia SG
          </a>{' '}
          and{' '}
          <a
            className="text-info"
            href="https://twitter.com/ikansumbat?lang=en"
          >
            @ikansumbat
          </a>
          ...
          fill in the form{' '}
          <a className="text-info" href="https://forms.gle/stgnm6FdhrZpMoi17">
            here
          </a>
          .
          <br />
          ...
          <a
            className="text-info"
            href="https://www.instagram.com/adila_s/?hl=en"
          >
            Adila
          </a>
        </p>
